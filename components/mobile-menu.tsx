...
export function MobileMenu({ isOpen, showMenu }: { isOpen: boolean, showMenu: Dispatch<SetStateAction<boolean>> }) {
    ...
    return (
        <div className="xl:hidden p-[16px] md:p-[20px] flex flex-col justify-between pt-[42px] md:pt-[42px] bg-primary z-10 transition-all fixed top-0 left-0 bottom-0 right-0" style={{ transform: isOpen ? "translateY(0)" : "translateY(-100vh)" }}>
            ...
            <div className="flex flex-col justify-between flex-1 mt-[32px] md:mt-[80px]">
                ...
                <div className="text-[#929292] text-[14px] leading-[18px] md:leading-20px flex justify-between items-end">
                    <div className="flex flex-col mt-auto gap-[8px]">
                        <Link onClick={() => showMenu(false)} className=" hover:text-white" href="/form">Help Center</Link>
