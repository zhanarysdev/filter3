...
export function SelectLang() {
  ...
  return (
    <div className="relative max-w-96 z-50">
      ...
      >
        <div className="text-[14px] leading-[18px] md:leading-[20px] lg:text-[16px] lg:leading-[20px]  xl:text-[18px] xl:leading-[24px]  xl:text-primary font-medium">
          {selected.label}
        </div>
      ...
      <div
        className={
          isOpen
            ? `flex absolute top-0 left-0 lg:right-0 lg:left-auto`
            : `hidden`
        }
      >
        <ul className="bg-[#F8F8F8] rounded-lg p-[10px] w-[227px] flex flex-col gap-[5px]">
          ...
          >
            <Link
              className="text-[14px] leading-[18px] lg:text-[16px] lg:leading-[20px] xl:text-[18px] xl:leading-[24px] md:leading-[20px] font-medium"
              href={selected.href}
            >
              {selected.label}
            </Link>
          ...
          {data.map((el) => (
            <li
              className="flex text-[14px] leading-[18px]  lg:text-[16px] lg:leading-[20px] xl:text-[18px] xl:leading-[24px] md:leading-[20px] justify-between items-center"
              key={el.label}
              onClick={() => {
                changeLang(el);
                setOpen(false);
            ...
            >
              <Link
                className={`text-[14px] leading-[18px] md:leading-[20px] lg:text-[16px] lg:leading-[20px] xl:text-[18px] xl:leading-[24px]font-medium text-[#929292] hover:text-[#373737]`}
