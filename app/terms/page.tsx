      ...
      >
        <div className="mt-[20px] md:mt-[40px] lg:mt-[30px] [&>p]:mt-[5px] lg:[&>p]:mt-[10px] text">
          ...
          <p>
            ...
            questions. For information about our data practices, please see our
            Privacy Policy and our Cookie Policy. We collect, use and share
          ...
          <p>
            ...
            updated if it changes. To create an account or otherwise use Filter,
            you must be at least 13 years old and you must also be old enough to
          ...
          <p>
            You are responsible for all activity on your account. If you violate
            our terms or policies, then we may terminate your account. Don’t do
          ...
          <p>
            To become an influencer, simply launch your page to start your
            membership. When you join Filter, you become part of the Filter
            community. You can use influencer tools that we provide to Filters,
            among other things, showcase your creations, engage with the Filter
            community.
          </p>
          <p>
          ...
          <p>
            ...
            reproduce, store, translate, transmit, distribute, perform, prepare
            derivative works, publicly display and display in connection with
            any name, username, voice or likeness provided in connection with
            it. If your creations contain any personal data, you also recognise
            Filter’s “legitimate interest” in it in accordance with the scope of
            this licence.
          </p>
          <p>
