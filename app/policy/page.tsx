...
const Title = ({ children }: { children: ReactNode }) => (
  <h2 className="text-[22px] leading-[26px] mt-[16px] font-bold">{children}</h2>
);
const SubTitle = ({ children }: { children: ReactNode }) => (
  <h4 className="font-bold text-[14px] mt-[12px] leading-[18px]">{children}</h4>
);
const Text = ({ children }: { children: ReactNode }) => (
  <p className="text-[14px] leading-[18px] mt-[8px]">{children}</p>
);
...
export default function Policy() {
  return (
    <section className="lg:flex lg:h-full overflow-y-scroll">
      ...
      <Container className="lg:flex-1  lg:overflow-y-scroll">
        <div>
          <Title>Privacy Policy of www.filter.li</Title>
          <Text>
            Privacy Policy of www.filter.li In order to receive information
            about your Personal Data, the purposes and the parties the Data is
            shared with, contact the Owner. For more information and to
            understand your rights, you can also view the complete version of
            this privacy policy, by clicking the link at the bottom right of
            this page.
          </Text>
          ...
          <Text>
            <b>Owner contact email:</b> community@filter.li
          </Text>
          ...
          <Text>
            ...
            by this Application or by the owners of third-party services used by
